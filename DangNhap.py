...
# lab_ Đăng Nhập
lab_DangNhap = Label(frmDangNhap, text="ĐĂNG NHẬP HỆ THỐNG",font=("Times New Roman", 20, "bold"),bg="#E6F2FA")
lab_DangNhap.pack(pady=(30, 5))

subtitle = Label(frmDangNhap,text="WELLCOME HỆ THỐNG QUẢN LÝ KHÁCH SẠN TOM&JERRY",font=("Times New Roman", 10),bg="#E6F2FA")
subtitle.pack(pady=(0, 20))

# lab Tên đăng nhập + entry
lab_TenDangNhap = Label(frmDangNhap,text="Tên đăng nhập: ",font=("Times New Roman", 12),bg="#E6F2FA",anchor="w")
...
# lab + entry mật khẩu
lab_MatKhau = Label(frmDangNhap, text="Mật khẩu: ", font=("Times New Roman", 12), bg="#E6F2FA", anchor="w")
...
lab_XacNhan = Label(frmDangNhap, text="Nhập lại mật khẩu: ", font=("Times New Roman", 12), bg="#E6F2FA", anchor="w")
lab_XacNhan.pack(fill="x", padx=50)
confirm_entry = Entry(frmDangNhap, font=("Times New Roman", 12), width=30, show="*")
confirm_entry.pack(pady=5)

# btn Đăng Nhập
Dangnhap_btn = Button(frmDangNhap, text="Đăng Nhập", font=("Times New Roman", 12), bg="#00AEEF", fg="white", width=20,command=DangNhap)
